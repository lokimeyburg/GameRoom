GameRoom is a very simple Rails app to showcase [Stacker](https://github.com/lokimeyburg/Stacker), an iOS view-controller to make building hybrid native/web iOS apps much simpler.
